  ...
  */
  ...
  function createFormatters(cache) {
      ...
      var getDateTimeFormat = memoizeIntl$1(function () {
          ...
          return new ((_a = Intl.DateTimeFormat).bind.apply(_a, __spreadArrays$2([void 0], args)))();
      }, {
      ...
      var getNumberFormat = memoizeIntl$1(function () {
          ...
          return new ((_a = Intl.NumberFormat).bind.apply(_a, __spreadArrays$2([void 0], args)))();
      }, {
      ...
      var getPluralRules = memoizeIntl$1(function () {
          ...
          return new ((_a = Intl.PluralRules).bind.apply(_a, __spreadArrays$2([void 0], args)))();
      }, {
      ...
      return {
          ...
          getRelativeTimeFormat: memoizeIntl$1(function () {
              ...
              return new (RelativeTimeFormat.bind.apply(RelativeTimeFormat, __spreadArrays$2([void 0], args)))();
          }, {
          ...
          getListFormat: memoizeIntl$1(function () {
              ...
              return new (ListFormat.bind.apply(ListFormat, __spreadArrays$2([void 0], args)))();
          }, {
          ...
          getDisplayNames: memoizeIntl$1(function () {
              ...
              return new (DisplayNames.bind.apply(DisplayNames, __spreadArrays$2([void 0], args)))();
          }, {
  ...
  function formatMessage(_a, state, messageDescriptor, values) {
      ...
      values = __assign$5(__assign$5({}, defaultRichTextElements), (values || {}));
  ...
  function getFormatter(_a, type, getDateTimeFormat, options) {
      ...
      var defaults = __assign$6(__assign$6({}, (timeZone && { timeZone: timeZone })), (format && getNamedFormat(formats, type, format, onError)));
      ...
      if (type === 'time' &&
          ...
          filteredOptions = __assign$6(__assign$6({}, filteredOptions), { hour: 'numeric', minute: 'numeric' });
      }
  ...
  function createIntl(config, cache) {
      ...
      var resolvedConfig = __assign$7(__assign$7({}, DEFAULT_INTL_CONFIG), config);
  ...
  var DEFAULT_INTL_CONFIG$1 = __assign$8(__assign$8({}, DEFAULT_INTL_CONFIG), { textComponent: React.Fragment });
  /**
  ...
  function injectIntl(WrappedComponent, options) {
      ...
      var WithIntl = function (props) { return (React.createElement(IntlConsumer, null, function (intl) {
          ...
          return (React.createElement(WrappedComponent, __assign$9({}, props, intlProp, { ref: forwardRef ? props.forwardedRef : null })));
      })); };
      WithIntl.displayName = "injectIntl(" + getDisplayName(WrappedComponent) + ")";
      WithIntl.WrappedComponent = WrappedComponent;
      if (forwardRef) {
          return hoistNonReactStatics$1(React.forwardRef(function (props, ref) { return (React.createElement(WithIntl, __assign$9({}, props, { forwardedRef: ref }))); }), WrappedComponent);
      }
  ...
  var createIntl$1 = function (_a, cache) {
      var rawDefaultRichTextElements = _a.defaultRichTextElements, config = __rest$1(_a, ["defaultRichTextElements"]);
      var defaultRichTextElements = assignUniqueKeysToFormatXMLElementFnArgument(rawDefaultRichTextElements);
      var coreIntl = createIntl(__assign$a(__assign$a({}, DEFAULT_INTL_CONFIG$1), config), cache);
      return __assign$a(__assign$a({}, coreIntl), { formatMessage: formatMessage$1.bind(null, {
  ...
  var FormattedRelativeTime = /** @class */ (function (_super) {
      ...
      FormattedRelativeTime.prototype.render = function () {
          ...
          return (React.createElement(Context.Consumer, null, function (intl) {
              ...
              var formattedRelativeTime = formatRelativeTime(currentValue, currentUnit, __assign$b({}, _this.props));
              if (typeof children === 'function') {
  ...
  var FormattedMessage = /** @class */ (function (_super) {
      ...
      FormattedMessage.prototype.shouldComponentUpdate = function (nextProps) {
          var _a = this.props, values = _a.values, otherProps = __rest$2(_a, ["values"]);
          var nextValues = nextProps.values, nextOtherProps = __rest$2(nextProps, ["values"]);
