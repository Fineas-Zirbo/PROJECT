(function (global, factory) {
  ...
  */
  ...
  var DEFAULT_INTL_CONFIG$1 = __assign$5(__assign$5({}, DEFAULT_INTL_CONFIG), { textComponent: React.Fragment });
  /**
  ...
  function injectIntl(WrappedComponent, options) {
      ...
      var WithIntl = function (props) { return (React.createElement(IntlConsumer, null, function (intl) {
          ...
          return (React.createElement(WrappedComponent, __assign$6({}, props, intlProp, { ref: forwardRef ? props.forwardedRef : null })));
      })); };
      WithIntl.displayName = "injectIntl(" + getDisplayName(WrappedComponent) + ")";
      WithIntl.WrappedComponent = WrappedComponent;
      if (forwardRef) {
          return hoistNonReactStatics$1(React.forwardRef(function (props, ref) { return (React.createElement(WithIntl, __assign$6({}, props, { forwardedRef: ref }))); }), WrappedComponent);
      }
  ...
  var createIntl$1 = function (_a, cache) {
      ...
      var coreIntl = createIntl(__assign$7(__assign$7({}, DEFAULT_INTL_CONFIG$1), config), cache);
      return __assign$7(__assign$7({}, coreIntl), { formatMessage: formatMessage$1.bind(null, {
  ...
  var FormattedRelativeTime = /** @class */ (function (_super) {
      ...
      FormattedRelativeTime.prototype.render = function () {
          ...
          return (React.createElement(Context.Consumer, null, function (intl) {
              ...
              var formattedRelativeTime = formatRelativeTime(currentValue, currentUnit, __assign$8({}, _this.props));
              if (typeof children === 'function') {
